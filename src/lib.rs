...
pub trait MiniscriptKey: Clone + Eq + Ord + str::FromStr + fmt::Debug +fmt::Display {
    type Hash: Clone + Eq + Ord + str::FromStr + fmt::Display + fmt::Debug + ToHash160 + hash::Hash;
...
impl ToHash160 for String{

    fn to_hash160(&self) -> hash160::Hash{
        hash160::Hash::from_str(&self).unwrap()
    }
}
